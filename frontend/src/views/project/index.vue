                  ...
                  <el-dropdown @command="handleCommand" class="h-[16px] flex items-center ml-[12px]">
                    ...
                    <template #dropdown>
                      <el-dropdown-menu>
                        ...
                        <el-dropdown-item :command="{ data: row, type: 'inject_variable' }">注入变量</el-dropdown-item>
...
import { ProgrammeList } from "@/wailsjs/go/controller/Template";
